...
<form name="promotionA_form" action="promoA_prcss.php" method="post">
	<h1>Purchase With Purchase Tupperware Promotions</h1>
	<table border='0' width="700px">
		<tr>
			<td valign='top'>
				<table border='1' width="60%" valign='center' style="border-collapse: collapse;">
					<tr>
						<td align='center' width='40px'><b><font size='3'>Step 1</font></b></td>
						<td align='center'><b><font size='3'>Step 2</font></b></td>
					</tr>
					<tr>
						<td width='100px'>
