	...
	{		
		...
		{ 
			...
			if(strpos($product_id, 'PKG_') !== false)
			{
				...
				$total_point_reward = $total_point_reward + ($promotion_package_point * $product_qty);
			...
			}else
			{
				...
				if($member_commercial_status == '0')
				{
					...
					$total_point_reward = $total_point_reward + ($product_point * $product_qty);
				}else if($member_commercial_status == '1')
				{
					if($member_commercial_class=='1')
					{
						...
						$total_point_reward = $total_point_reward + ($product_commercial_point * $product_qty);
					...
					}else if($member_commercial_class == '2')
					{
						...
						$total_point_reward = $total_point_reward + ($product_commercial_point2 * $product_qty);
					}else
					{
						if($product_commercial_handling_show == '0')
						{
