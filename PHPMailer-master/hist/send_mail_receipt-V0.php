					...
					<div id='body' align='center'>
						<table border='0' align='center' width='700px' height='100px' cellspacing='0' cellpadding='0'>
							<tr>
								...
								<th width='5px'>:</th>
								<td width='150px'>&nbsp;$member_mobile</td>
							</tr>
							<tr>
	...
	{		
		...
		{ 
			...
			}else
			{
				...
				$cd_subtotal = cal_price($product_price, $total_handling_charge, $product_qty, $product_sale1, $product_sale_percentage1, $product_sale2, $product_sale_percentage2, $product_sale3, $product_sale_percentage3);
		...
		$card_subtotal = number_format($card_subtotal, 2);
