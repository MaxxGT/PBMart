...
$sql_refillGas_promotion = "SELECT * FROM pbmart_promotion WHERE promotion_category_id ='$category_id' AND promotion_show!='0' AND promotion_package_stock > 0 AND promotion_start_date <='$current_date' AND promotion_end_date >= '$current_date'";
