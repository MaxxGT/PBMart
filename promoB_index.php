<?php
	...
	$sql_promoA = "SELECT * FROM pbmart_promotion WHERE promotion_category_id = '2' AND promotion_show = '1' AND promotion_package_stock !='0' AND promotion_package_stock >'0' AND promotion_start_date <='$current_date' AND promotion_end_date >='$current_date'";
	$promotion_ids = '2';
?>
<html>
<!DOCTTYPE HTML>
...
<form name="prmA" action="product_validate.php?act=add&id=1&product_category=Promotion&product_qty=1&hyperlink=index" method="post">
	...
	<table border='0' width="725px">
		<tr>
			<td valign='top'>
				<table border='1' style="border-color:black" width="100%" valign='center'>
					<!-- <tr>
					...
					<tr>
						<td width='550px'>
							<table border='0'>
								...
								<tr>
									<td valign='top'><input type="radio" checked /></td>
									<td>CLESSE GAS REGULATOR WITH SAFETY VALVE <BR/>(AUTO CUT) RM89.99</td>
								</tr>
							</table>
