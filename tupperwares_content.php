...
<!--Products Line  -->
	<BR/>
	<h1>Our Tupperware</h1> <br /> <br />
		<?php include('page_navigate.php'); ?>
		
						<?php
							$filter = "WHERE product_stock !='0' AND product_stock > 0 AND product_category_id='16'";
						...
						while($rw = mysql_fetch_array($rs))
						{
						  ...
						  <?php }
										...
										{ //echo $count;
											...
											if($count >= 0 && $count <= 1)
											{ $count++; $count2++; ?>
												<li><a href="tupperware.php?hyperlink=tupperware&product_id=<?php echo $product_id; ?>" style="text-decoration: none">
													...
													<div class="product-info">
														...
														<div class="product-desc">
																...
																<table border='0' width='230px' height='110px' style="margin-top:-10px; margin-left:-10px;">
																	<tr>
																		<td height='40px' valign='center'><font size='3' color='black'><B><?php echo $product_model; ?></B></font></td>
																	</tr>
																	<tr>
																		<td height='30px'>
																			<strong class="price">
																	...
																	<tr>
																		<td>
																			<a class='button' href="product_validate.php?act=add&product_id=<?php echo $product_id; ?>&product_category_id=<?php echo $product_category_id; ?>&product_category=<?php echo $product_category; ?>&product_qty=1&hyperlink=tupperware"><span style='font-size:15px;color:#FFFFFF;'> ADD TO CART</span></a>
																		</td>
																	</tr>
																</table>
														</div>	
									  ...
									  <?php }else
											{ //echo ('div end called');?>				
												<li class="last"><a href="tupperware.php?hyperlink=tupperware&product_id=<?php echo $product_id; ?>" style="text-decoration: none">
