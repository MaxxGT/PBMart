<?php
	...
	$sql_promoA = "SELECT * FROM pbmart_product WHERE product_category_id = '29' AND product_stock !='0'";
	
	$promotion_ids = '1';
?>
<html>
<!DOCTTYPE HTML>
<TITLE>PBMART MEMBER BIRTHDAY PROMOTIONS</TITLE>
<BODY>
<div id="main">
<form action="product_validate.php?act=add&id=1&product_category=Product&product_qty=1&hyperlink=index" method="post">
	<table border='0' width='100%'>
		<tr>
			<td>
				<strong><font size=5 color='black'>TRIPLE POINTS PROMOTIONS</font></strong>
			</td>
		</tr>
		<tr>
			<td>
