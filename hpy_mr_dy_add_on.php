<?php
	...
	$sql_promoA = "SELECT * FROM pbmart_product WHERE product_category_id = '16' AND product_stock !='0'"; 
?>
<form name="spc_pm_add_on_form" action="spc_prm_prcss.php" method="post">
	<table border='0'>
		<tr>
			<td>
				<strong><font size=5 color='black'>Free Gift Items</font></strong>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td valign='top'>
				<table border='0' valign='center' style="border-collapse: collapse;">
					...
					<tr>
						...
						<BR/>
						<hr/>
							<input type="submit" value="ADD TO CART" <?php echo $btnSubmit; ?>></input>
						</td>
					</tr>
				</table>
			</td>
