...
<form id="spc_prm_form" name="spc_prm_form" action="product_validate.php?trigger=product" method='post'>
	...
	<input type="hidden" name="hyperlink" value="welcome_2016"></input>
	<script language="JavaScript">document.spc_prm_form.submit();</script>
</form>