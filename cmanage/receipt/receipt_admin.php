			...
			<div id="content">
				...
				<table border="1" align="center" width="680px" height="20px" cellspacing="0" cellpadding="0" id="item">
					<tr height="20px">
						...
						{ ?>
							<th width="50px" align='center'>MYGAZ</th>
							<th width="50px" align='center'>PETRONAS</th>
				  <?php } ?>
					...
					<tr>
						...
						<td width="500px" valign="top">
							<?php	$total	= 0;
									...
									if($member_display['member_commercial_status'] == 1)
									{
										echo "<td width='50px' valign='top' style='text-align:center;padding-right:12px;'>".$order_display['order_mygaz_amount']."</td>";
										echo "<td width='50px' align='center' style='text-align:center;padding-right:12px;'>".$order_display['order_petronas_amount']."</td>";
									}
									echo "<td width='50px' valign='top' style='text-align:right;padding-right:12px;'>";
									if($total == 0){
										echo "-";
									}else{
