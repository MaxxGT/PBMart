...
$num_rows = mysql_num_rows($result);
 //$test=mysql_query($result,$conn) or die(mysql_error();

if ($num_rows > 0)
	{
	

	$sql = "INSERT INTO mobile_devices (id, email, device_id, type) SELECT pbmart_member.member_id, pbmart_member.member_email, '$deviceID', '$type' FROM pbmart_member where member_email='$email';";
