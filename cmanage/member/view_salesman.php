<?php
	...
	if(!empty($_GET['search']) != ""){
		...
		$total_pages_que = "SELECT COUNT(*) as num FROM pbmart_salesman WHERE member_first_name LIKE'%".$searchKey."%' OR member_last_name LIKE'%".$searchKey."%' OR member_email LIKE'%".$searchKey."%'";
		$member_que = "SELECT * FROM pbmart_salesman WHERE member_first_name LIKE'%".$searchKey."%' OR member_last_name LIKE'%".$searchKey."%' OR member_email LIKE'%".$searchKey."%' OR member_ic LIKE '".$searchKey."%' LIMIT $start, $limit";
	}else if(!empty($_GET['key']) != ""){
		$keyword = mysqli_real_escape_string($dbconnect, $_GET['key']);
		$total_pages_que = "SELECT COUNT(*) as num FROM pbmart_salesman WHERE member_first_name LIKE'".$keyword."%' OR member_last_name LIKE'".$keyword."%'";
		$member_que = "SELECT * FROM pbmart_salesman WHERE member_first_name LIKE'".$keyword."%' OR member_last_name LIKE'".$keyword."%' LIMIT $start, $limit";
	}else{
		$total_pages_que = "SELECT COUNT(*) as num FROM pbmart_salesman";
		$member_que = "SELECT * FROM pbmart_salesman LIMIT $start, $limit";
	}
	...
	<body>
			...
			<div id="tabs">
				 <div class="container">
					<ul>
						...
						<li><a href="view_salesman.php?hyperlink=members" class="current"><span>Salesmans</span></a></li>   
		...
		<div class="grid_16" id="content">	
			...
			<div style="width:300px;margin-left:20px;">
				<div style="text-align:left;padding-left:10px;"><u><strong>Salesman Status Legend:</strong></u></div>
					<div>
			...
			<table border="1"  width="900px" cellpadding="0" cellspacing="0" class="box-table-a">
				<tr>
					<th colspan="9" align="center">Salesman Management</th>
				</tr>
				...
				<tr>
					...
					<th width="100px" style="padding-left:5;">Salesman ID.</th>
					<th width="300px" style="padding-left:5;">Salesman Name</th>
					<th width="150px" style="padding-left:5;">E-mail</th>
					<th width="30px" style="padding-left:5;">Contact</th>
					<th width="30px" style="padding-left:5;"></th>
				...
				<?php	while($member_display = mysqli_fetch_array($member)){	?>
							<tr>
								...
								<td width="50px" style="padding-left:5;"><?=$member_display['salesman_id']?>
								</td>
								<td width="200px" style="padding-left:5;"><?=$member_display['salesman_name']?></td>
								<td width="150px" style="padding-left:5;"></td>
								<td align="right" width="70px" style="padding-right:5;"></td>
								<td align="right" width="70px" style="padding-right:5;"></td>
								<?php	if(0 == 0){
											$color = "red";
										}else{
