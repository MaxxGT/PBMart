		...
		<table border="1" width="800px" class="box-table-a">
					...
					<tr>
						...
						<td colspan='3'>
						 <div class="side-by-side clearfix">	
							<div>
							  <select id="selection" name='product[]' data-placeholder="Select Products" style="width:580px;" class="chosen-select" multiple tabindex="6">
								<option value=""></option>
								<optgroup label="ALL">
									<option value="ALL">SELECT ALL</option>
									<option value="ALL_SALE">SELECT ALL (SALES ONLY)</option>
								</optgroup>
									<?php
								...
								<input name="btnSubmit" type="image" src='images/report(1).png' width='30px' height='30px' Value="Generate Products Reports" title="Generate Products Reports"></input>
								<input name="btnSubmit" type="image" src='images/pdf.png' width='30px' height='30px' Value="Generate Products PDF" title="Generate Products PDF"></input>
							</div>
						 </div>
						</td>
					...
					<tr>
						...
						<td colspan='3'>
							<div class="side-by-side clearfix">	
							<div>
							  <select id="selection" name='promotion[]' data-placeholder="Select Promotions" style="width:580px;" class="chosen-select" multiple tabindex="6">
								<option value=""></option>
							  ...
							  <input name="btnSubmit" type="image"  src='images/report(1).png' width='30px' height='30px' Value="Generate Promotions Reports"></input>
							  <input name="btnSubmit" type="image"  src='images/pdf.png' width='30px' height='30px' Value="Generate Promotions PDF"></input>
							</div>
							</div>
					...
					<tr>
						...
						<td colspan='3'>
							<input name="btnSubmit" type="image"  src='images/report(1).png' width='30px' height='30px' Value="Generate Flat Handling Reports"></input>
							<input name="btnSubmit" type="image"  src='images/pdf.png' width='30px' height='30px' Value="Generate Flat Handling PDF"></input>
						</td>
					</tr>
					<tr>
