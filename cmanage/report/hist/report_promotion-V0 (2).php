				...
				<?php
					...
					while($rw_product = mysqli_fetch_array($rs_product))
					{
						...
						<tr>
							...
							<td>
								<a href="report_order.php?id=<?php echo $product_id; ?>&year=<?php echo $YEARS; ?>&month_from=<?php echo $month_from; ?>&month_to=<?php echo $month_to; ?>&class=Product" style="text-decoration: none;">
									<font color='black'><?php echo '<B>'.$promotion_item_name.'</B> - '.$promotion_product_model.' - RM'.$promotion_package_price; ?></font>
								</a>
							</td>
