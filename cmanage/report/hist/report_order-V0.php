	...
	<div class="grid_16" id="content">	
			...
			<table class="box-table-a" align="center"width="928px">
				...
				<?php
					...
					$iCount = '1';
					$sql_pbmart_order = "Select order_number, order_customer_id, order_customer_name, order_amount, order_date, order_status, order_complete_date FROM pbmart_order WHERE MONTH(order_complete_date) BETWEEN '$month_from' AND '$month_to' AND YEAR(order_complete_date) = '$YEARS' AND order_status='1'";
