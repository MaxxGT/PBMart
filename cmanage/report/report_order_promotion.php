...
?>
	...
	<div class="grid_16" id="content">	
			...
			<table class="box-table-a" align="center"width="928px">
				...
				<?php
					$sql_product = "SELECT * FROM pbmart_promotion WHERE promotion_id='$id'";
					$rs_product = mysqli_query($dbconnect, $sql_product);
					$rw_product = mysqli_fetch_array($rs_product);
					$promotion_product_name = $rw_product['promotion_product_name'];
					$promotion_product_model = $rw_product['promotion_product_model'];
					$promotion_product_photo = $rw_product['promotion_product_photo'];
					$promotion_item_photo = $rw_product['promotion_item_photo'];	
				?>
						<tr>
							<td colspan='5'>
								&nbsp;&nbsp;&nbsp;
								<img src='../promotion/<?php echo $promotion_product_photo; ?>' width='150px' height='125px' />
								<img src='../promotion/<?php echo $promotion_item_photo; ?>' width='150px' height='125px' />
									<h2><B><?php echo $promotion_product_name.' - '.$promotion_product_model; ?></B><BR/></h2>
							</td>
						</tr>
					<?php
				?>
					...
					while($rw_pbmart_order = mysqli_fetch_array($rs_pbmart_order))
					{
						...
						?>
							<tr>
								...
								<td align='center'><B><a href="../order/view_orderList.php?or=<?php echo $order_number; ?>&view=or&hyperlink=orders"><?php echo $order_number; ?></a></B></td>
								<td>
									<B>
									<?php 
