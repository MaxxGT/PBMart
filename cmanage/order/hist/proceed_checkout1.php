					...
					<td align="center">
						<table border="0" width="600px" height="300px" align="center" cellpadding="0" cellspacing="0" class="box-table-a">
							...
							<tr>
								...
								<td>
									<input type="text" id="delivery" name="delivery" onclick="javascript:NewCssCal('delivery','yyyyMMdd','arrow')" style="cursor:pointer"/>
								</td>
							</tr>
							<tr>
								...
								<td>
									<select id="preferance_time" name="preferance_time">
										...
										<table border="1" align="center" id="item_cart" width="340px" height="300px" cellpadding="0" cellspacing="0">
											<tr>
												<td align="center" bgcolor="yellow"><span class="tittle">SHOPPING CART</span></td>
											</tr>
											<tr>
												<td align="left">
													<table border="0" width="340px" cellpadding="0" cellspacing="0">
														<thead>
															<tr>
																<td width="180px" style="padding-left:5;padding-top:5;">Product</td>
																<td width="80px" style="padding-left:5;">Price (RM)</td>
																<td width="80px" style="padding-left:5;">Unit(s)</td>
															</tr>
														</thead>
														<tbody>
															<?php	while($cart_display = mysqli_fetch_array($cart)){
															...
															?>
																<tr>
																	<td width="180px" style="padding-left:5;padding-top:5;"><?php	echo $cart_no.". ";?><?=$cart_display['cart_product_name']?></td>
																	<td width="80px" style="padding-left:5;"><?=$cart_display['cart_product_price']?></td>
																	<td width="80px" style="padding-left:5;"><?=$cart_display['cart_product_amount']?></td>
																</tr>
															<?php	$cart_no++;
																	}
															?>
											...
											<tr>
												<td>
													<table border="0" id="pricing" width="340px" cellpadding="0" cellspacing="0">
														<thead>
															<tr>
																<td width="180px" style="padding-left:5;">Handling Charge (RM) : </td>
																<td style="padding-left:5;"><?=$total_handling?></td>
															</tr>
														</thead>
														<thead>
															<tr>
																<td width="180px" style="padding-left:5;">Total amount (RM) : </td>
																<td style="padding-left:5;"><?=$total_amount?></td>
															</tr>
														</thead>
													</table>
												</td>
								...
								<tr>
									<td align="center" style="border-top-style:hidden;">
