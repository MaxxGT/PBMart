...
public $_commercial_upload_types;
public $_commercial_form_authorization;

public $_commercial_form_registration;
public $_commercial_form_borang1;
public $_commercial_form_lesen_runcit;
public $_commercial_form_mpp;
...

{
	...
	$this->_commercial_upload_types = $commercial_upload_types;
	$this->_commercial_form_authorization = $commercial_form_authorization;
	$this->_commercial_form_registration = $commercial_form_registration;
	$this->_commercial_form_borang1 = $commercial_form_borang1;
	$this->_commercial_form_lesen_runcit = $commercial_form_lesen_runcit;
	$this->_commercial_form_mpp = $commercial_form_mpp;
    ...
    function getCommercialbyId(){
        ...
        while ($row = @mysql_fetch_array($result)){
            ...
            $list->setCommercial($row['commercial_id'], $row['commercial_member_id'], $row['commercial_member_number'], $row['commercial_number'], $row['commercial_company'],
                $row['commercial_company_number'], $row['commercial_phone'], $row['commercial_address'], $row['commercial_city'], $row['commercial_postcode'], $row['commercial_state'], $row['commercial_country'], $row['commercial_person_incharge'], $row['commercial_person_ic'], $row['commercial_person_position'], $row['commercial_person_phone'], $row['commercial_upload_types'], $row['commercial_form_authorization'], $row['commercial_form_registration'], $row['commercial_form_borang1'], $row['commercial_form_lesen_runcit'], $row['commercial_form_mpp'], $row['commercial_form49'], $row['commercial_form24'], $row['commercial_form9'], $row['commercial_status'], $row['commercial_application_date']);
            $Commercial[$list->getCommercialId()] = $list;
        }
        return $Commercial;
    }
	
	function getCommercialInfo_byId($member_id){
        //global $dbConnect;
