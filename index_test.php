...
<!-- Shell -->
 ...
 <div id='cssmenu'>
	<ul>
		<h1><a href="index.php?hyperlink=home">PB MART</a></h1>
    <!-- Cart -->
  ...
  <?php } ?>
    ...
    <!-- Navigation -->
        ...
        <li class='has-sub'><a href="products.php?hyperlink=product" class="<?php echo $hyperlink2; ?>">Products</a>
			<ul>
				<li><a href='#'><span>Gas Related Product</span></a>
				</li>
					<li><a href='#'><span>Tupperware Product</span></a>
				</li>
			</ul>
		</li>
		<li><a href="redemption.php?hyperlink=redemption" class="<?php echo $hyperlink6; ?>">Redeem</a></li>
		<li><a href="reward.php?hyperlink=reward" class="<?php echo $hyperlink9; ?>">Reward</a></li>
	<?php
  ...
  <?php } ?>
		<li><a href="help.php?hyperlink=help" class="<?php echo $hyperlink4; ?>">Help</a></li>
        <li><a href="contact.php?hyperlink=contact" class="<?php echo $hyperlink5; ?>">Contact Us</a></li>
